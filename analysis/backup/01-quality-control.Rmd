...
wrap_plots(
  plotColData(sce, "sum", colour_by = "phenotype") + scale_y_log10() + ggtitle("Total count"),
  plotColData(sce, "detected", colour_by = "phenotype") + scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce, "subsets_MT_percent", colour_by = "phenotype") + ggtitle("MT percent"),
  plotColData(sce, "altexps_ERCC_percent", colour_by = "phenotype") + ggtitle("ERCC percent")
)
```
...
patchwork::wrap_plots(
  plotPCA(sce, colour_by = "sum", shape_by = "phenotype") + ggtitle("Total count"),
  plotPCA(sce, colour_by = "detected", shape_by = "phenotype") + ggtitle("Detected features"),
  plotPCA(sce, colour_by = "subsets_MT_percent", shape_by = "phenotype") + ggtitle("MT percent"),
  plotPCA(sce, colour_by = "altexps_ERCC_percent", shape_by = "phenotype") + ggtitle("ERCC percent"),
  ncol = 2
)
```
...
```{r, fig.height = 9, fig.width = 10}
patchwork::wrap_plots(
  plotTSNE(sce, colour_by = "sum", shape_by = "phenotype") + ggtitle("Total count"),
  plotTSNE(sce, colour_by = "detected", shape_by = "phenotype") + ggtitle("Detected features"),
  plotTSNE(sce, colour_by = "subsets_MT_percent", shape_by = "phenotype") + ggtitle("MT percent"),
  plotTSNE(sce, colour_by = "altexps_ERCC_percent", shape_by = "phenotype") + ggtitle("ERCC percent"),
  ncol = 2
)
```
...
```{r, fig.height = 9, fig.width = 10}
patchwork::wrap_plots(
  plotUMAP(sce, colour_by = "sum", shape_by = "phenotype") + ggtitle("Total count"),
  plotUMAP(sce, colour_by = "detected", shape_by = "phenotype") + ggtitle("Detected features"),
  plotUMAP(sce, colour_by = "subsets_MT_percent", shape_by = "phenotype") + ggtitle("MT percent"),
  plotUMAP(sce, colour_by = "altexps_ERCC_percent", shape_by = "phenotype") + ggtitle("ERCC percent"),
  ncol = 2
)
```
...
dat <- DataFrame(
  ...
  low_n_features = sce$detected < 3000,
  high_subsets_MT_percent = sce$subsets_MT_percent > 4,
  high_altexps_ERCC_percent = sce$altexps_ERCC_percent > 1
)
...
```{r}
wrap_plots(
  plotColData(sce, "sum", colour_by = "manual_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Total count"),
  plotColData(sce, "detected", colour_by = "manual_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce, "subsets_MT_percent", colour_by = "manual_discard", shape_by = "phenotype") + ggtitle("MT percent"),
  plotColData(sce, "altexps_ERCC_percent", colour_by = "manual_discard", shape_by = "phenotype") + ggtitle("ERCC percent")
)
```
...
```{r}
dat <- quickPerCellQC(sce, percent_subsets = c("subsets_MT_percent", "altexps_ERCC_percent"), batch = sce$phenotype)
...
```{r}
wrap_plots(
  plotColData(sce, "sum", colour_by = "adaptive_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Total count"),
  plotColData(sce, "detected", colour_by = "adaptive_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce, "subsets_MT_percent", colour_by = "adaptive_discard", shape_by = "phenotype") + ggtitle("MT percent"),
  plotColData(sce, "altexps_ERCC_percent", colour_by = "adaptive_discard", shape_by = "phenotype") + ggtitle("ERCC percent")
)
```
...
out <- isOutlier(adj, type = "higher", batch = sce$phenotype)
...
```{r}
wrap_plots(
  plotColData(sce, "sum", colour_by = "outlier_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Total count"),
  plotColData(sce, "detected", colour_by = "outlier_discard", shape_by = "phenotype") + scale_y_log10() + ggtitle("Detected features"),
  plotColData(sce, "subsets_MT_percent", colour_by = "outlier_discard", shape_by = "phenotype") + ggtitle("MT percent"),
  plotColData(sce, "altexps_ERCC_percent", colour_by = "outlier_discard", shape_by = "phenotype") + ggtitle("ERCC percent")
)
```
...
Additionally, we are going to select cells with at least 1 ERCC read count:

```{r}
idx <- which(sce$altexps_ERCC_detected > 0)
