...
hvg <- getTopHVGs(dec, var.field = "bio", n = 2000)
...
hvg <- getTopHVGs(dec, var.field = "ratio", n = 2000)
...
plt <- lapply(dec, function(x) {
  ...
  plotPCA(sce, colour_by = "phenotype") + ggtitle(x)
...
plt <- lapply(dec, function(x) {
  ...
  plotTSNE(sce, colour_by = "phenotype") + ggtitle(x)
...
plt <- lapply(dec, function(x) {
  ...
  plotUMAP(sce, colour_by = "phenotype") + ggtitle(x)
