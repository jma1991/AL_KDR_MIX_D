...
```{r}
var <- c("sum", "detected", "cluster_walktrap", "phenotype")
```
...
```{r}
var <- c("sum", "detected", "cluster_louvain", "phenotype")
```
...
```{r}
var <- c("sum", "detected", "cluster_kmeans", "phenotype")
```
...
```{r}
var <- c("sum", "detected", "cluster_hclust", "phenotype")
```
